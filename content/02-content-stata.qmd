...
In the last tutorial, we learned some Stata basics. We are going to continue with the basics in a more "Stata" friendly way. Let's start by loading our dataset `fake_scores.dta`. You can find this dataset in the repository, or download directly [here](https://raw.githubusercontent.com/RRMaximiliano/edu-harvard-programming/master/files/data/fake_scores.dta).
